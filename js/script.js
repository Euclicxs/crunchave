    ...
    menuAddButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (itemName.includes('Wave Solo') || itemName.includes('Crunch Duo') || itemName.includes('Family Wave')) {
                ...
                // Regular menu items - show size selection
            ...
            customizationOptions = `
                ...
                <div class="customization-section">
                    ...
                    <div class="dessert-options">
                        <button class="dessert-option" data-dessert="Crunchy Sundae Wave" data-price="279">🍦 Crunchy Sundae Wave (+₱279)</button>
                        <button class="dessert-option" data-dessert="Chocolate Wave Cake" data-price="329">🍰 Chocolate Wave Cake (+₱329)</button>
                        <button class="dessert-option" data-dessert="Apple Pie Crunch" data-price="249">🥧 Apple Pie Crunch (+₱249)</button>
                        <button class="dessert-option" data-dessert="Cinnamon Crunch Donuts" data-price="219">🍩 Cinnamon Crunch Donuts (+₱219)</button>
                    </div>
                </div>
            `;
        }
